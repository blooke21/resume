$(document).ready(function () {
  ...
  if (firstTime) {
    ...
    if (windowWidth >= 500) {
      $(".spotlight").animate({ "background-position-x": "-20em", "background-position-y": "5em" }, 800)
        .promise().done(
          $(".spotlight").delay(200).animate({ "background-position-x": "10em", "background-position-y": "5em" }, 500))
        .promise().done(
          $(".spotlight").delay(200).animate({ "background-position-x": "-20em", "background-position-y": "-5em" }, 300)
        )
        .promise().done(
          $(".spotlight").delay(200).animate({ "background-position-x": "30em", "background-position-y": "-9em" }, 800)
        )
        .promise().done(
          $(".spotlight").delay(200).animate({ "background-position-x": "-10em", "background-position-y": "-9em" }, 800)
        )
        .promise().done(
          $(".spotlight").animate({ "background-position-x": "0em", "background-position-y": "-10em" }, 200)
        )
        .promise().done(
          $(".spotlight").delay(200).animate({ "opacity": "0" }, 500)
        )
    } else {
      $(".spotlight").animate({ "background-position-x": "3em", "background-position-y": "10em" }, 800)
        .promise().done(
          $(".spotlight").delay(200).animate({ "background-position-x": "-3em", "background-position-y": "-12em" }, 500))
        .promise().done(
          $(".spotlight").delay(200).animate({ "background-position-x": "3em", "background-position-y": "1em" }, 300)
        )
        .promise().done(
          $(".spotlight").delay(200).animate({ "background-position-x": "7em", "background-position-y": "-7em" }, 800)
        )
        .promise().done(
          $(".spotlight").delay(200).animate({ "background-position-x": "-8em", "background-position-y": "-10em" }, 800)
        )
        .promise().done(
          $(".spotlight").animate({ "background-position-x": "0em", "background-position-y": "-10em" }, 200)
        )
  ...
  //sets the animations for inside box and bobbles, this is done in JS so a delay can be added if the spotlight animation plays
  $(".inside-box").css({ "animation": "removeInsideBox 1s " + insideBoxDelay + "s ease-in-out forwards" })
    .promise().done(
  ...
  $("#bobbleOne").css({ "animation": "growBox 1s " + boxGrowTime + "s ease-in-out forwards" })
  $("#bobbleTwo").css({ "animation": "growBox 1s " + (boxGrowTime + .35) + "s ease-in-out forwards" })
  $("#bobbleThree").css({ "animation": "growBox 1s " + (boxGrowTime + .15) + "s ease-in-out forwards" })
  $("#bobbleOne .inside-bobble").css({ "animation": "text-slide 1s " + (boxGrowTime + 1) + "s ease-in-out forwards" })
  $("#bobbleTwo .inside-bobble").css({ "animation": "text-slide 1s " + (boxGrowTime + 1.35) + "s ease-in-out forwards" })
  $("#bobbleThree .inside-bobble").css({ "animation": "text-slide 1s " + (boxGrowTime + 1.15) + "s ease-in-out forwards" })
        ...
        switch (ranLocation) {
          ...
          case 1: //moves inside-box top to bottom along the right side of box-container
            ...
            $(this)
              ...
              //returns inside-box to normal size
              .promise()
              .done($(this).find(".inside-box").animate({ width: "100px" }, 100))
              .promise()
              .done(
                $(this)
                  .find(".inside-box")
          ...
          case 2: //moves inside-box right to left along the bottom of box-container
            ...
            $(this)
              .find(".inside-box")
              .css({ width: "100px", height: "2px", marginTop: $(this).height() });
